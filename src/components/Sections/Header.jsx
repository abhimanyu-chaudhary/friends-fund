          ...
          <QuoteWrapper className="flexCenter darkBg radius8">
            ...
            <div>
              <p className="font15 whiteColor">
                <em>"A good friend knows all your stories, but a best friend helps you write the best chapters of life."</em>
              </p>
              <p className="font13 orangeColor textRight" style={{marginTop: '10px'}}>- Anonymous Authors</p>
            </div>
          </QuoteWrapper>
          <DotsWrapper>
            <Dots />
